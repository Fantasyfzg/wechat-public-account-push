...
const USER_CONFIG = {
  ...
  USERS: [
    ...
    },
    {
      ...
      city: "镇雄",
      // 认识该好友的时间
      weChatFriendFirstDay: "2021-03-09",
      // 新历生日, 仅用作获取星座运势, 格式必须
      horoscopeDate: '03-29',
      // 获取什么时候的星座运势，可选：['今日', '明日', '本周', '本月', '今年'], 留空则随机
      horoscopeDateType: '今日',
    ...
    },
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "iGDeuOPJMGPzAo5mMPWzU8pMDMTpPpa4UNUAjDat1zE",
      // 所在省份
      province: "云南",
      // 所在城市
      city: "昆明",
      ...
      // 我给对方的留言
       mywords: [{
        contents: [
          ...
          "若似月明终皎洁，不辞冰雪为卿热。",
          "有好多话想对你说。",
          "如果你看到这句话，你就去点击详情去看看我博客园置顶的第一条随笔吧！",
          "我们高一开学军训的第一天，我就看出了大哥的与众不同。这是我藏在心里的秘密。"
        ]
      }]
    },
    {
